...
pub fn build(b: *std.Build) void {
    ...
    if (target_os == .windows) {
        ...
        for ([_][]const u8{ "model_test", "download_test", "download_transfer_test", "inject_test", "inject_plan_test", "crash_test", "waveform_test", "history_test", "palette_test", "utf8_test", "modelsel_test", "opacity_test", "overlay_layout_test", "settings_test", "tray_fmt_test" }) |test_name| {
            ...
            t.root_module.addCSourceFiles(.{
                .root = b.path("windows/src"),
                .files = &.{ "strconv.c", "inject_plan.c", "history.c", "palette.c", "utf8.c", "modelsel.c", "opacity.c", "overlay_layout.c", "tray_fmt.c" },
                .flags = &.{ "-O0", "-std=c11", "-Wall", "-Wextra" },
            });
    ...
    if (target_os == .macos) {
        ...
        swift_compile.addFileArg(b.path("macos/Sources/ModelDownloader.swift"));
        swift_compile.addFileArg(b.path("macos/Sources/Notifications.swift"));
